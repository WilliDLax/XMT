...
extern void *mono_aot_module_GroupExperiment_info;
...
extern void *mono_aot_module_System_Net_Http_Formatting_info;
...
extern void *mono_aot_module_Newtonsoft_Json_Bson_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_GroupExperiment_info);
	...
	mono_aot_register_module (mono_aot_module_System_Net_Http_Formatting_info);
	...
	mono_aot_register_module (mono_aot_module_Newtonsoft_Json_Bson_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "GroupExperiment.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
